...
export default function Home() {
	...
	return (
		<>
			...
			<form
				className="rounded-full bg-neutral-200/80 flex items-center w-full max-w-3xl border border-transparent hover:border-neutral-300 focus-within:border-neutral-400 hover:focus-within:border-neutral-400"
				onSubmit={handleFormSubmit}
			>
				<input
					type="text"
					className="bg-transparent focus:outline-hidden p-4 w-full placeholder:text-neutral-500 text-gray-900"
					required
				...
				<button
					type="submit"
					className="p-4 text-neutral-700 hover:text-black"
					disabled={isPending}
					aria-label="Submit"
				>
			...
			<div className="text-neutral-600 pt-4 text-center max-w-xl text-balance min-h-28 space-y-4">
				{messages.length > 0 && (
					<p>
